...
let test_parse_equal_to_condition_is_true =
...
let test_parse_equal_to_condition_is_false =
    let fails = (None: nat option) in
...
let test_parse_not_equal_to_condition_is_true =
    let fails = (None: nat option) in
    let foo = 3 in
...
(*
let test_parse_not_equal_to_condition_is_false =
    let fails = (None: nat option) in
    let foo = 3 in
...
let test_parse_less_than_condition_is_true =
    let fails = (None: nat option) in
    let foo = 2 in
...
let test_parse_less_than_condition_is_false =
    let fails = (None: nat option) in
    let foo = 2 in
...
let test_parse_less_than_or_equal_condition_is_true =
    let fails = (None: nat option) in
    let foo = 3 in
...
let test_parse_less_than_or_equal_condition_is_false =
    let fails = (None: nat option) in
    let foo = 3 in
...
let test_parse_greater_than_condition_is_true =
    let fails = (None: nat option) in
    let foo=4 in
...
let test_parse_greater_than_condition_is_false =
    let fails = (None: nat option) in
    let foo=4 in
...
let test_parse_greater_than_or_equal_condition_is_true =
    let fails = (None: nat option) in
    let foo=4 in
...
let test_parse_greater_than_or_equal_condition_is_false =
    let fails = (None: nat option) in
    let foo=4 in
